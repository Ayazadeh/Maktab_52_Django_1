...
class OrderStatus(models.Model):
    status = models.CharField(max_length=30, verbose_name="status:", help_text="add status for order's")
...
class Orders(models.Model):
    ...
    number = models.PositiveIntegerField(default=1, verbose_name="number of item's:", help_text="add number of item's")
